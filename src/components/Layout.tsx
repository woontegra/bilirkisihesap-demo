  ...
  if (hideHeader) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
        ...
        <main className="w-full py-10" style={{ paddingBottom: '3.5rem' }}>
          <div className="w-full min-w-0 px-4 sm:px-6 lg:px-10">
            <div className={`w-full mx-auto ${fluid ? 'max-w-none' : 'max-w-[1400px]'}`}>
              {children}
            </div>
          </div>
        </main>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
      ...
      <header className="sticky top-0 z-30 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700">
        <div className={`h-16 flex items-center justify-between gap-3 w-full min-w-0 px-4 sm:px-6 lg:px-10 ${!fluid ? 'max-w-[1400px] mx-auto' : ''}`}>
          {/* Title section */}
