...
export default function ReportPreviewButton({ title, renderContent, buttonClassName, buttonStyle, copyTargetId, onPdf, onButtonClick, hideButton, autoOpen, hideWordDownload }: Props) {
