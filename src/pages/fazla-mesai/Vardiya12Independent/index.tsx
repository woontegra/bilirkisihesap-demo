...
const PAGE_TITLE = "12 Saat Usulü Vardiya";

export default function Vardiya12Independent() {
  const videoLink = getVideoLink("fazla-vardiya12");

  return (
    <Layout 
      title={PAGE_TITLE}
      description="12 Saat Usulü Vardiya Hesaplama"
      rightSlot={videoLink ? (
        <Button
