...
type Props = {
  ...
  buttonIcon?: ReactNode; // İkon (metnin solunda)
  ...
  return (
    <>
      {!hideButton && (
        <button
          type="button"
          className={buttonClassName || "bg-purple-600 hover:bg-purple-700 text-white text-xs sm:text-sm font-medium px-2 sm:px-3 py-1.5 rounded-md transition whitespace-nowrap flex items-center justify-center gap-2"}
          style={buttonStyle}
