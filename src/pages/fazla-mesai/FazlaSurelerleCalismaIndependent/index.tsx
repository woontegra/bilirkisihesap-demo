...
const PAGE_TITLE = "Fazla Sürelerle Çalışma";

export default function FazlaSurelerleCalismaIndependent() {
  const videoLink = getVideoLink("fazla-surelerle-calisma");

  return (
    <Layout 
      title={PAGE_TITLE}
      description="Fazla Sürelerle Çalışma Hesaplama"
      rightSlot={videoLink ? (
        <Button
