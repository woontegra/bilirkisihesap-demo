...
// Helper component: Standart Tablo (Word'de sayfa içine sığması için columnWidths kullanın)
export function ReportTable({
  ...
  columnWidths?: string[]; // Örn. ['22%','10%',...] – Word yapıştırmada taşmayı önler
}) {
  return (
    <table style={{
      width: '100%',
...
// Helper component: Brüt → Net Tablosu (Word kopyala-yapıştırda üst çizgi için thead satırı)
...
// Helper component: Mahsuplaşma Tablosu (Word kopyala-yapıştırda üst çizgi için thead satırı)
