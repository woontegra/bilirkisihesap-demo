...
interface ZamanasimiModalProps {
  ...
  iseGiris?: string; // İşe giriş tarihi - pandemi kontrolü için (3 kural)
}

// Modal içeriği - memo ile sarmalanmış
const ModalContent = React.memo(function ModalContent({
  ...
  // Hesaplama değerleri (Standart ile aynı pandemi kuralı - işe giriş bazlı 3 kural)
  ...
  const { dava, limit, gun, nihai, pandemiEklendi, pandemiGun = 0 } = calculations;
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        ...
        >
          ...
          <div style={{ color: "#f59e0b", fontSize: "13px", marginTop: "0.5rem", padding: "0.5rem", background: "#fef3c7", borderRadius: "4px", border: "1px solid #fbbf24" }}>
            <b>Pandemi Dönemi:</b> 13 Mart 2020 - 15 Haziran 2020. {pandemiGun > 0 ? `İşe girişe göre +${pandemiGun} gün eklendi.` : "İşe giriş 15.06.2020 sonrası veya girilmediği için pandemi süresi uygulanmadı."}
          </div>
