 ...
 * Kaynak: Çalışma ve Sosyal Güvenlik Bakanlığı (Resmî Gazete)
 * Değerler 16 yaş üstü için Brüt Asgari Ücret baz alınarak girilmiştir.
 */
...
/**
 * Verilen tarihe göre geçerli brüt asgari ücreti döndürür.
