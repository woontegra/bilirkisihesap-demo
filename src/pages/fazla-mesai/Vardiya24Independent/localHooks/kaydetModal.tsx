 ...
 * Tüm hesaplama sayfaları için ortak modal
 */
...
import {
  ...
  DialogDescription,
  DialogFooter,
} from "../localComponents/ui/dialog";
...
export default function KaydetModal({
  ...
  // Modal açıldığında veya defaultName değiştiğinde state'i güncelle
  useEffect(() => {
    if (open) {
      if (defaultName) {
        setName(defaultName);
      } else {
        // Varsayılan ad: "Hesap Türü - Bugünün Tarihi"
