  ...
  return (
    <div
      className={clsx(
        ...
        "h-[57px] sm:h-[61px]",
        "px-4 pt-0 pb-0",
        "flex flex-nowrap justify-between items-center gap-2 sm:gap-3 md:gap-4",
    ...
    >
      ...
      {previewButton && (
        <ReportPreviewButton
          ...
          buttonClassName={previewButton.buttonClassName || "bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium px-3 py-1.5 rounded-md transition"}
