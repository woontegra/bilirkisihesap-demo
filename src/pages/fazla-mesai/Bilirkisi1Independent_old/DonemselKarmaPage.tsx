...
// DonemselKarmaPage.tsx - DONEMSEL_HAFTALIK_KARMA scenario only
...
function FazlaMesaiBilirkisi1PageContent({ titleOverride }: Props) {
  ...
  // DONEMSEL_HAFTALIK_KARMA PAGE - Scenario is hardcoded
  useEffect(() => {
    setCalculationScenario('DONEMSEL_HAFTALIK_KARMA');
  }, [setCalculationScenario]);
