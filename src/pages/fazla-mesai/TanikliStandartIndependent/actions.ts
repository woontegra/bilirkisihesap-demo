...
export async function handleLoadCalculation(
  ...
  try {
    const result = await loadCalculation(caseId, "tanikli_standart_fazla_mesai");
    ...
    console.error("[Tanıklı Standart Fazla Mesai] Hesaplama yüklenirken hata oluştu:", err);
    return null;
  }
}
