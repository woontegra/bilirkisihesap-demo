...
interface BasinIsHaftaTatiliReportNetConversionProps {
  totalBrut: number;
  selectedYear: number;
}
...
export default function BasinIsHaftaTatiliReportNetConversion({ totalBrut, selectedYear }: BasinIsHaftaTatiliReportNetConversionProps) {
