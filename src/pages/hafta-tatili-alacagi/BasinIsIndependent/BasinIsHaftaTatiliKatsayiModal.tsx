...
interface BasinIsHaftaTatiliKatsayiModalProps {
  open: boolean;
  onClose: () => void;
  onApply: (katsayi: number) => void;
}

export default function BasinIsHaftaTatiliKatsayiModal({ open, onClose, onApply }: BasinIsHaftaTatiliKatsayiModalProps) {
