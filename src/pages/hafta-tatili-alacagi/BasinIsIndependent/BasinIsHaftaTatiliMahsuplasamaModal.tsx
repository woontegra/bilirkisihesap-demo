...
interface BasinIsHaftaTatiliMahsuplasamaModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  tableData: BasinIsHaftaTatiliTableRow[];
  onSave: (total: number, data: { [year: number]: { [month: number]: number } }) => void;
}

export default function BasinIsHaftaTatiliMahsuplasamaModal({
  open,
  onOpenChange,
  tableData,
  onSave,
}: BasinIsHaftaTatiliMahsuplasamaModalProps) {
