...
export default function HaftaTatiliReportModal({
    ...
    try {
      ...
      const html = `<!doctype html>
        <html>
          ...
          <body>
            <div class="print-title">Standart Hafta Tatili Alacağı – Rapor Görünümü</div>
            ${source}
          </body>
        </html>`;
  ...
  const handleHaftaTatiliDownloadWord = async () => {
    try {
      ...
      await downloadWordDocument(
        "Standart Hafta Tatili Alacağı – Rapor Görünümü",
  ...
  // ESC key handling moved to DraggableModal

  // Body overflow management moved to DraggableModal
