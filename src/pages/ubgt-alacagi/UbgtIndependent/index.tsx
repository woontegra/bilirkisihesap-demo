...
import UbgtHolidaySelectCompact from "./UbgtHolidaySelectCompact";
import {
...
export default function UbgtIndependent() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const workerPeriods = formData.workerPeriods || formData.data?.form?.workerPeriods || formData.form?.workerPeriods;
        ...
        const excludedUbgtHolidaysForm = formData.excludedUbgtHolidays || formData.data?.form?.excludedUbgtHolidays || formData.form?.excludedUbgtHolidays;
        const ubgtExclusionRulesForm = formData.ubgtExclusionRules || formData.data?.form?.ubgtExclusionRules || formData.form?.ubgtExclusionRules;
  ...
  const handleNewCalculation = () => {
    try {
      ...
      if (id) {
        window.location.href = "/ubgt-alacagi";
      }
    } catch {}
  };
  ...
  return (
    <Layout
      title={PAGE_TITLE}
      description="UBGT Alacağı Hesaplama"
      hideHeader={true}
      fluid={true}
      pageKey="ubgt"
    ...
    >
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        {/* Print Area: Sadece bu alan yazdırılacak */}
        <div id="ubgt-calculation-area" className="w-full space-y-6">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="fade-section">Çalışma dönemlerinizi ekleyin</CardDescription>
                </div>
        ...
        {/* Brütten Nete Çevir + Mahsuplaşma - tam sayfa genişliği */}
        ...
        {/* Not Alanı - üst bloklarla aynı genişlik (ubgt-calculation-area içinde) */}
        <div className="w-full min-w-0 overflow-x-hidden mt-4 box-border">
