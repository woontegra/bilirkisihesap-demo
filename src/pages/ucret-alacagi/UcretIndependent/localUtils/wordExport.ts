...
export async function downloadWordDocument(title: string, containerId: string, fileName?: string): Promise<void> {
  ...
  if (!reportData.sections?.length) throw new Error("Word export: İçerik bulunamadı");
