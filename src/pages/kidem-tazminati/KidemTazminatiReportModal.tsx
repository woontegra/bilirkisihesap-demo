...
export default function KidemTazminatiReportModal({ data }: { data: KidemReportData }) {
  ...
  // totals.toplam aylık brüt ücret olmalı
  // Eğer 0 ise, data.toplamBrut'tan ters hesapla
            ...
            <tbody>
              ...
              {data.muafiyetTutari !== undefined && (
                <tr>
                  ...
                  <td style={{ border: '1px solid #d1d5db', padding: '8px', textAlign: 'right' }}>
                    {formatCurrency(data.muafiyetTutari)}
                  </td>
                </tr>
              )}
              {data.gelirVergisi !== undefined && (
                <tr>
                  <td style={{ border: '1px solid #d1d5db', padding: '8px' }}>
                    Gelir Vergisi {!data.gelirVergisiUygulanacak && "(Muafiyet Nedeniyle Uygulanmadı)"}
                  </td>
                  <td style={{ border: '1px solid #d1d5db', padding: '8px', textAlign: 'right' }}>
                    {formatCurrency(data.gelirVergisi)}
                  </td>
                </tr>
              )}
