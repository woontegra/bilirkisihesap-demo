        ...
        >
          <div className="flex items-center gap-2 flex-1 min-w-0" style={{ minWidth: "200px" }}>
            ...
            <div className="flex gap-1 ml-2 shrink-0">
              <button type="button" onMouseDown={(e) => e.stopPropagation()} onClick={() => toggleMinimize()} className="w-6 h-6 rounded hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400" title={isMinimized ? "Genişlet" : "Küçült"}>
                {isMinimized ? "🔼" : "🔽"}
              </button>
              <button type="button" onMouseDown={(e) => e.stopPropagation()} onClick={() => toggleMaximize()} className="w-6 h-6 rounded hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400" title={isMaximized ? "Küçült" : "Tam Ekran"}>
                {isMaximized ? "🗗" : "🗖"}
              </button>
            </div>
          </div>
