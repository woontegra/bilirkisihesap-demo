...
// Helper component: Standart Tablo (Word kopyala-yapıştır: columnWidths + wordWrap)
...
// Helper component: Brüt → Net Tablosu (Word: üst çizgi için thead satırı)
      ...
      <tbody>
        {rows.map((row, idx) => (
          <tr key={idx} style={{
            ...
            <td style={{ ...cellStyle, textAlign: 'right' as const, fontVariantNumeric: 'tabular-nums' }}>
              {row.value}
            </td>
          </tr>
        ))}
...
// Helper component: Mahsuplaşma Tablosu (Word: üst çizgi için thead satırı)
