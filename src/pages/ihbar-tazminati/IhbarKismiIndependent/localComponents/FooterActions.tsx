...
type FooterActionsProps = {
  ...
  previewButton?: {
    ...
    buttonIcon?: ReactNode; // Örn. <Eye /> - Yazdır/Kaydet gibi solda ikon
    ...
    >
      ...
      {previewButton && (
        <ReportPreviewButton
          ...
          buttonClassName={previewButton.buttonClassName || "bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium px-3 py-3 md:py-2 rounded-md transition w-full md:w-auto flex items-center justify-center gap-2"}
          renderContent={previewButton.renderContent}
          buttonIcon={previewButton.buttonIcon}
