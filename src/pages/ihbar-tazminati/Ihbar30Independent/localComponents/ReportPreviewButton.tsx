  ...
  return (
    <>
      {!hideButton && (
        <button
          type="button"
          className={buttonClassName || "bg-purple-600 hover:bg-purple-700 text-white text-xs sm:text-sm font-medium px-2 sm:px-3 py-2 rounded-lg transition whitespace-nowrap flex items-center justify-center gap-1.5 sm:gap-2"}
          style={buttonStyle}
